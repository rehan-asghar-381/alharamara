                ...
                <div class="card ">
                    <div class="card-body card-breadcrumb d-flex align-items-center justify-content-between">
                        <div class="page-title-box mb-0">
                            <h4 class="mb-0">Edit Labor Cost</h4>
                        </div>
                        <div>
            ...
            <div class="col-12 box-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.labor-costs.update', $laborCost) }}">
                            @method('PUT')
                            @include('admin.labor_costs.form', [
                                'submitLabel' => 'Update Labor Cost',
                            ])
                        </form>
                    </div>
                </div>
