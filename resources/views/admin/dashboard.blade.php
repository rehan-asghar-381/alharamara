...
@push('scripts')
    ...
    <script src="{{ asset('js/intro-active.js') }}"></script>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="revenue-card text-center">
                                <div class="offer-img">
                                    <img src="{{ asset('img/bg-img/offer.jpg') }}" alt="">
                                </div>
                                <h6>Total Revenue</h6>
                                <h2>$40,000.00</h2>
                                <p>
                            ...
                            <div class="product-list-area" id="product">
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="product-img">
                                            <img src="{{ asset('img/shop-img/1.png') }}" alt="">
                                        </div>
                                ...
                                <div
                                    ...
                                    <div
                                        class="product-meta-info d-flex align-items-center">
                                        <div class="product-img">
                                            <img src="{{ asset('img/shop-img/2.png') }}" alt="">
                                        </div>
                                        <div class="product-info">
                                ...
                                <div
                                    ...
                                    <div
                                        class="product-meta-info d-flex align-items-center">
                                        <div class="product-img">
                                            <img src="{{ asset('img/shop-img/3.png') }}" alt="">
                                        </div>
                                        <div class="product-info">
                                ...
                                <div
                                    ...
                                    <div
                                        class="product-meta-info d-flex align-items-center">
                                        <div class="product-img">
                                            <img src="{{ asset('img/shop-img/4.png') }}" alt="">
                                        </div>
                                        <div class="product-info">
                                ...
                                <div
                                    ...
                                    <div
                                        class="product-meta-info d-flex align-items-center">
                                        <div class="product-img">
                                            <img src="{{ asset('img/shop-img/5.png') }}" alt="">
                                        </div>
                                        <div class="product-info">
                                            <span>New Watch</span>
                                            <p class="mb-0">$365</p>
